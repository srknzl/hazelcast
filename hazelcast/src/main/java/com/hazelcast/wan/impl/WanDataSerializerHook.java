...
import com.hazelcast.map.impl.wan.PublishWanEventOperation;
...
public class WanDataSerializerHook implements DataSerializerHook {
    ...
    public static final int WAN_MIGRATION_PUBLISH_EVENT = 5;
    ...
    public DataSerializableFactory createFactory() {
        return typeId -> {
            switch (typeId) {
                ...
                case WAN_MIGRATION_PUBLISH_EVENT:
                    return new PublishWanEventOperation();
                default:
